...
export const calculateENMO = (accel_x, accel_y, accel_z) => {
  ...
  if (enmoValue < 0.1) {
    enmoPosition = 45;
  } else if (enmoValue >= 0.1 && enmoValue < 0.2) {
    enmoPosition = 145;
  } else if (enmoValue >= 0.2 && enmoValue <= 0.3) {
    enmoPosition = 245;
  } else if (enmoValue > 0.3) {
    enmoPosition = 345;
  } else {
    enmoPosition = 0;
  }
...
export const determineStressLevel = (color1, color2, color3) => {
  ...
  if (colorSet.size === 1) {
    ...
    if (color === "green") {
      ...
      image = (
        <Image
          source={require("../components/images/green.png")}
          style={styles.image}
        />
      );
    } else if (color === "red") {
      ...
      image = (
        <Image
          source={require("../components/images/red.png")}
          style={styles.image}
        />
      );
      ...
      image = (
        <Image
          source={require("../components/images/orange.png")}
          style={styles.image}
        />
      );
      ...
      image = (
        <Image
          source={require("../components/images/yellow.png")}
          style={styles.image}
        />
      );
    }
    ...
    colorSet.has("red") &&
    (colorSet.has("orange") || colorSet.has("yellow"))
  ) {
    stress = "Very High";
    image = (
      <Image
    ...
    image = (
      <Image
        source={require("../components/images/default.png")}
        style={styles.image}
      />
    );
  }
